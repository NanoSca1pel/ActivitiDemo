...
public class CamundaDemoTest {
    ...
    public void testDeploy() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("bpmn/camunda-demo.bpmn20.xml") //增加bpmn.xml文件
                .name("审批流程demo") //名称
                .deploy();
    ...
    public void testStartProcess() {
        ...
        ProcessInstance instance = runtimeService.startProcessInstanceByKey("camunda");
